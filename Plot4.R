...
with(power_consumption, plot(DateTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power", xaxt = "n"))
...
with(power_consumption, plot(DateTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage", xaxt = "n"))
axis(side = 1, at = c(as.numeric(power_consumption$DateTime[1]), as.numeric(power_consumption$DateTime[1441]), as.numeric(power_consumption$DateTime[2880])), labels = c("Thu", "Fri", "Sat"))
...
with(power_consumption, plot(DateTime, Global_reactive_power, type= "l", xlab = "datetime", ylab = "Global_reactive_power", xaxt = "n"))
axis(side = 1, at = c(as.numeric(power_consumption$DateTime[1]), as.numeric(power_consumption$DateTime[1441]), as.numeric(power_consumption$DateTime[2880])),labels = c("Thu","Fri","Sat"))
